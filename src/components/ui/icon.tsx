...
const paths = {
  ...
  facebook: 'M13.5 21v-7h2.6l.4-3h-3V9.1c0-.9.3-1.5 1.6-1.5H16.7V5c-.3 0-1.2-.1-2.3-.1-2.3 0-3.9 1.4-3.9 4V11H8v3h2.5v7',
  youtube: 'M21 12s0-3.2-.4-4.7a2.5 2.5 0 0 0-1.7-1.7C17.4 5.2 12 5.2 12 5.2s-5.4 0-6.9.4a2.5 2.5 0 0 0-1.7 1.7C3 8.8 3 12 3 12s0 3.2.4 4.7a2.5 2.5 0 0 0 1.7 1.7c1.5.4 6.9.4 6.9.4s5.4 0 6.9-.4a2.5 2.5 0 0 0 1.7-1.7C21 15.2 21 12 21 12ZM10 8.8l5.2 3.2L10 15.2V8.8Z',
  instagram: 'M7.5 3.5h9a4 4 0 0 1 4 4v9a4 4 0 0 1-4 4h-9a4 4 0 0 1-4-4v-9a4 4 0 0 1 4-4ZM12 8.2a3.8 3.8 0 1 0 0 7.6 3.8 3.8 0 0 0 0-7.6ZM17.2 6.9h.01',
} as const;
